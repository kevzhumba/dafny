  ...
  class UnionFind ... {
    ghost predicate ValidM1()
    {
      ...
      forall e :: 
        e in M ==>
          M[e].c.Root? &&
          Reaches(M[e].c.depth, e, M[e], Collect())
    }
...
abstract module M2 refines M1 {
  class UnionFind ... {
    ...
    {
      match e.c
      case {:split false} Root(_ /* _v1 */) =>
        r := e;
      case {:split false} Link(next) =>
        NextReachesSame(e);
        r := FindAux(d - 1, next);
        ghost var C := Collect();
        e.c := Link(r);
...
module M3 refines M2 {
  class UnionFind ... {
    ...
    lemma {:autocontracts false} JoinMaintainsReaches1(r0: Element, r1: Element, C: CMap, C': CMap)
      ...
      requires GoodCMap(C')
      ensures forall d: nat, e, r: Element {:induction} :: e in C && Reaches(d, e, r, C) && r != r0 && r != r1 ==> Reaches(d, e, r, C')
