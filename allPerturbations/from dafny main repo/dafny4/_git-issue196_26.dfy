...
method TestD()
{
  ...
  b := new array2<int>[5] (_ /* _v0 */ => a);
  var c: array3<array<array2<int>>> := new array<array2<int>>[5, 4, 3];
  c := new array<array2<int>>[5, 4, 3] ((_ /* _v1 */, _ /* _v2 */, _ /* _v3 */) => b);
}
...
method TestE()
{
  ...
  var b: array?<array2?<int>> := new array2?<int>[5];
  b := new array2?<int>[5] [a, a, a, a, a];
  b := new array2?<int>[5] (_ /* _v4 */ => a);
  var c: array3?<array?<array2?<int>>> := new array?<array2?<int>>[5, 4, 3];
  c := new array?<array2?<int>>[5, 4, 3] ((_ /* _v5 */, _ /* _v6 */, _ /* _v7 */) => b);
  var d: array15?<int>;
  var e: array16<int>;
}
